 ...
 */
class AddNewStandardBotBig implements ActionListener {
    ...
    /**
     * Create an AddNewStandardBotBig event handler.
     *
     * @param newView The parent view.
     * @param model The model.
     */
    public AddNewStandardBotBig(final MainPanel newView, BW4TClientConfig model) {
        this.view = newView;
        this.model = model;
    }

    /**
     * Listens to the add big standard bot button.
     * Executes action that needs to happen when the "Big Standard Bot" button is
     * pressed. Gives default name of "Big Standard Bot &lt;n&gt;" where &lt;n&gt; is the n'th bot created.  
     *
