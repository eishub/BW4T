...
public final class HallwayMenu {
	...
	/**
	 * Builds a pop up menu for when the player clicked on a hallway The string
	...
	public static void buildPopUpMenuForHallway(BW4TClientGUI gui, String gotohall) {
		...
		menuItem.addActionListener(new GotoPositionActionListener(gui.getSelectedLocation(), gui.getController()));
