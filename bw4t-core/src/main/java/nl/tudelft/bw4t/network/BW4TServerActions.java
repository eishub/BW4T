...
public interface BW4TServerActions extends Remote {
	 ...
	 * associated with the client to ensure the entities are also freed up for
	 * reuse, and also to ensure the client properly closes elements attached to
	 * the entities (particularly, GUIs).
	 * 
	 * @param client
	 ...
	 *             object call
	 */
	void performEntityAction(String entity, Action action) throws RemoteException;
	 ...
	 *             object call
	 */
	PerceptUpdate getPerceptsFor(String entity) throws RemoteException;
	 ...
	 * 
	 * @param action
	 * @return true iff action is supported by the environment.
	 * @throws RemoteException
	 *             if an exception occurs during the execution of a remote
	 *             object call
	 */
