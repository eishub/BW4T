...
public class RobotEntity implements EntityInterface {
	 ...
	 *            true if this entity should report locations of objects it
	 *            sees: the "position" percept. If false, those percepts always
	 *            return null. This is a performance option to reduce percepts
	 *            generated by bots connected to GOAL. These percepts are needed
	 *            to let humanbots function properly. If in doubt, set it to
	 *            true.
	 */
	 ...
	 * and the blocks. Send on change. ENV-1336 currently sent only when the
	 * entity is a HUMAN bot.
	 *
	 * @return postitions
	 */
