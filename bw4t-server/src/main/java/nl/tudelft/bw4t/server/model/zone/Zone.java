...
public abstract class Zone extends BoundedMoveableObject {
     ...
     * 
     * @param zone 
     * 				in which this zone needs to be created
     * @param space 
     * 				in which the zone needs to be created
     * @param grid 
     * 				in which the zone needs to be created
     * @param context 
     * 				in which the zone needs to be created
    ...
    public Zone(nl.tudelft.bw4t.map.Zone zone, BW4TServerMap context) {
        ...
        if (zone.getRenderOptions() != null) {
            this.isLabelVisible = zone.getRenderOptions().isLabelVisible();
        }
