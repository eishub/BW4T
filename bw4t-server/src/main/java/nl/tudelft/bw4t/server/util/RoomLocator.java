...
public final class RoomLocator {
	...
	/**
	 * Returns the {@link BlocksRoom} the object is in. Note, {@link DropZone} is
	 * not a {@link BlocksRoom}
	 * 
	 * @param x
	 *            the x coordinate
	 * @param y
	 *            the y coordinate
	 * @return The {@link BlocksRoom} the given object is in or null if it is in the
	 *         hall.
	 */
	...
	/**
	 * Find {@link Room} containing given point. Both BlocksRoom and DropZone are
	 * Room.
	 * 
	 * @param x
	 *            the x coordinate
