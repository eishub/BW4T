...
public class ZoneLocatorTest {
	...
	@Mock
	private static Zone ZONE1 = mock(Zone.class);
	@Mock
	private static Zone ZONE2 = mock(Zone.class);
	@Mock
	private static Zone ZONE3 = mock(Zone.class);
	...
	/**
	 * Tests {@link ZoneLocator#getZonesAt(double, double)} at a location of a
	 * single Zone.
	 */
	@Test
	...
	/**
	 * Tests {@link ZoneLocator#getZonesAt(double, double)} at a location where 2
	 * Zones overlap.
	 */
	@Test
	public void getZonesAtTest2() {
		List<Zone> zones = ZoneLocator.getZonesAt(2, 0);
		assertTrue(zones.size() == 2 && ((zones.get(0).equals(ZONE2) && zones.get(1).equals(ZONE3))
	...
	/**
	 * Tests {@link ZoneLocator#getNearestZone(NdPoint)} with a point near
	 * overlapping Zones.
	 */
	@Test
	...
	/**
	 * Tests {@link ZoneLocator#getNearestZone(NdPoint)} with a point near
	 * overlapping Zones (opposite end).
	 */
	@Test
