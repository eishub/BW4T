...
public class ChatMenu {
    ...
    public static void buildPopUpMenuForChat(BW4TClientInfo bw4tClientinfo) {
        ...
        BasicMenuOperations.addSectionTitleToPopupMenu("Answer:",
                bw4tClientinfo.jPopupMenu);

        BasicMenuOperations.addMenuItemToPopupMenu(new BW4TMessage(
                MessageType.yes), bw4tClientinfo);
        BasicMenuOperations.addMenuItemToPopupMenu(new BW4TMessage(
                MessageType.no), bw4tClientinfo);
        BasicMenuOperations.addMenuItemToPopupMenu(new BW4TMessage(
                MessageType.iDoNotKnow), bw4tClientinfo);
        BasicMenuOperations.addMenuItemToPopupMenu(new BW4TMessage(
                MessageType.ok), bw4tClientinfo);
        BasicMenuOperations.addMenuItemToPopupMenu(new BW4TMessage(
                MessageType.iDo), bw4tClientinfo);
        BasicMenuOperations.addMenuItemToPopupMenu(new BW4TMessage(
                MessageType.iDoNot), bw4tClientinfo);
        BasicMenuOperations.addMenuItemToPopupMenu(new BW4TMessage(
                MessageType.wait), bw4tClientinfo);
        BasicMenuOperations.addMenuItemToPopupMenu(new BW4TMessage(
                MessageType.onTheWay), bw4tClientinfo);
        BasicMenuOperations.addMenuItemToPopupMenu(new BW4TMessage(
                MessageType.almostThere), bw4tClientinfo);
        BasicMenuOperations.addMenuItemToPopupMenu(new BW4TMessage(
                MessageType.farAway), bw4tClientinfo);
        BasicMenuOperations.addMenuItemToPopupMenu(new BW4TMessage(
                MessageType.delayed), bw4tClientinfo);
