...
public class RoomCellEditor extends AbstractCellEditor implements TableCellEditor {
	...
	private ZoneController room; // the room currently edited.
    ...
    public Object getCellEditorValue() {
        ZoneController newRoom = new ZoneController(0, 0); // coords are irrelevant for temp room
