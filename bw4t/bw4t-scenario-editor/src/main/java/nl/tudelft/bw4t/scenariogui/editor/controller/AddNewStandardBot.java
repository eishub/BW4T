 ...
 * @since       12-05-2014        
 */
class AddNewStandardBot implements ActionListener {
     ...
     */
    public AddNewStandardBot(final MainPanel newView, BW4TClientConfig model) {
        this.view = newView;
        this.model = model;
    }
    ...
    public void actionPerformed(final ActionEvent ae) {
        ...
        newBotConfig.setBotName("Standard Bot " + botCount);
