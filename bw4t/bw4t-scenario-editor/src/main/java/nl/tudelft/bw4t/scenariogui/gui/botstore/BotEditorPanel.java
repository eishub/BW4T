...
public class BotEditorPanel extends JPanel {
	...
	/**
	 * Side notes from Valentine: It would be nice to have the value of speed
	 * and size automatically change when a MoveSpeed or SizeOverload handicap
	 * is checked. This way, the BotEditorData updates the botSpeed and botSize
	 * to the right values, and we can use these values to instantiate the two
	 * handicaps. Also, once those values are automatically changed, we should
	 * disable user interaction with the sliders.
	 */
	/**
	...
	/**
	 * The button to be clicked on to reset all checkboxes and sliders to the
	 * initial values.
	 */
	private JButton resetButton = new JButton("Reset");
	/**
	 * The button to cancel the editing of the data object and to close the
	 * frame.
	 */
	private JButton cancelButton = new JButton("Cancel");

	/**
	 * The button that opens the file chooser to select an existing .goal file
	 * to use.
	 */
	...
	/**
	 * The checkbox for enabling/disabling the usage of a battery with finite
	 * capacity.
	 */
	private JCheckBox batteryEnabledCheckbox = new JCheckBox(
			"Battery Capacity enabled");
	/**
	 * The text field containing the file name the bot should use.
	 */
	private JTextField fileNameField = new JTextField(".goal");
	/**
	 * The text field containing the reference name of the bot.
	 */
	...
	/**
	 * A dynamically updated label to show what the usage of battery charge is
	 * per tick.
	 */
