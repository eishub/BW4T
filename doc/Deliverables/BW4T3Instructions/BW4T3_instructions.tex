...
A picture of the configuration panel can be found in Figure \ref{fig:ConfigPanel}.
\begin{figure}[h]
\begin{center}
...
The entity panel exists of 2 parts; the top part shows the bot options and the bottom part shows the e-partner options. A picture of the entity panel can be found in Figure \ref{fig:EntityPanel}.
\begin{figure}[h]
\begin{center}
...
A picture of the Bot Store can be found in Figure \ref{fig:BotStore}.
\begin{figure}[h]
\begin{center}
...
A picture of the E-partner Store can be found in Figure \ref{fig:EPartnerStore}.
