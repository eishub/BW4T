...
To create a new bot, click the $New$ $Bot$ button. A new bot will appear in the list.%The Bot Store will open in a new window where you can create your bot.
...
To rename a bot, you can either use the $Modify$ $Bot$ button to change it in the Bot Store, or you can change it in the scenario editor. To rename in the scenario editor, select the bot you want to rename in the list with bots. Double click the bot's name and enter a new name. %Enter the new name in the textfield above the $Rename$ $bot$ button and click the $Rename$ $bot$ button.
...
To create a new e-partner, click the $New$ $E-partner$ button. A new e-partner will appear in the list.%The Bot Store will open in a new window where you can create your bot.
