...
\item The Entity panel, where a list of bots and a list of e-partners are being displayed. Here you can create, modify and delete bots and e-partners.
\end{enumerate}
...
On the right side of the editor you can create, modify and delete bots and e-partners. There is also a list of bots and a list of e-partners that are created, and below each list there is an indication of how many bots or e-partners are created in total.
\pagebreak
...
To create a new bot, click the $New$ $Bot$ button. A new bot will appear in the bot list.%The Bot Store will open in a new window where you can create your bot.
...
To rename a bot, you can either use the $Modify$ $Bot$ button to change it in the Bot Store, or you can change it in the scenario editor. To rename in the scenario editor, select the bot you want to rename in the bot list. Double click the bot's name and enter a new name. %Enter the new name in the textfield above the $Rename$ $bot$ button and click the $Rename$ $bot$ button.
...
To rename an e-partner, select the e-partner you want to rename in the list with e-partners. Double click the e-partner's name and enter a new name. %Enter the new name in the textfield above the $Rename$ $bot$ button and click the $Rename$ $bot$ button.
